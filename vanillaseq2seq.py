# -*- coding: utf-8 -*-
"""VanillaSeq2Seq.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1qKxSoANZHmSevpkWEahxKBWcAJPSizvO
"""
...
class DataPreProcessor:
    def __init__(self):
      self.file_paths = {
          'file1': '/home/agcl/Desktop/aksharantar_sampled/mar/mar_test.csv',
          'file2': '/home/agcl/Desktop/aksharantar_sampled/mar/mar_test.csv',
          'file3': '/home/agcl/Desktop/aksharantar_sampled/mar/mar_train.csv'
      }
...
if __name__ == '__main__':
    ...
    parser.add_argument("--epochs", type=int, choices=[3,5,8], default=8)
    parser.add_argument("--hidden_size", type=int, choices=[64, 128, 256, 512], default=512)
    parser.add_argument("--enc_layers", type=int, choices=[2, 3], default=3)
    parser.add_argument("--dec_layers", type=int, choices=[2, 3], default=3)
    parser.add_argument("--dropout", type=float, choices=[0.3, 0.4], default=0.3)
...
# Defult+
# python VanillaSeq2Seq.py
# python VanillaSeq2Seq.py --optimiser adam --teacher_forcing_ratio 0.7 --bidirectional True --enc_embedding 256 --dec_embedding 256 --epochs 10 --hidden_size 512 --enc_layers 3 --dec_layers 3 --dropout 0.4 --cell_type lstm

#others
# python VanillaSeq2Seq.py --cell_type gru --hidden_size 256